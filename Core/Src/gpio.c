...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, MUX16_0_EN_Pin|GPIO_PIN_7|MUX8_0_EN_Pin|MUX8_0_A1_Pin
                          |MUX8_0_A0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, MUX8_1_EN_Pin|MUX8_1_A0_Pin|MUX8_1_A1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MUX8_1_A2_Pin|UCPD_DBn_Pin|GPIO_PIN_7, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PC13 VBUS_SENSE_Pin PC6 PC8
                           PC9 */
  GPIO_InitStruct.Pin = GPIO_PIN_13|VBUS_SENSE_Pin|GPIO_PIN_6|GPIO_PIN_8
                          |GPIO_PIN_9;
  ...
  /*Configure GPIO pins : MUX16_0_EN_Pin MUX8_0_EN_Pin MUX8_0_A1_Pin MUX8_0_A0_Pin */
  GPIO_InitStruct.Pin = MUX16_0_EN_Pin|MUX8_0_EN_Pin|MUX8_0_A1_Pin|MUX8_0_A0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : MUX8_1_A2_Pin */
  GPIO_InitStruct.Pin = MUX8_1_A2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(MUX8_1_A2_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : MUX8_3_A0_Pin MUX16_3_A0_Pin MUX16_3_EN_Pin MUX8_0_A2_Pin
                           MUX16_0_A0_Pin MUX16_0_A1_Pin MUX16_1_EN_Pin MUX16_1_A0_Pin */
  ...
  /*Configure GPIO pin : MUX16_0_A2_Pin */
  GPIO_InitStruct.Pin = MUX16_0_A2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MUX16_0_A2_GPIO_Port, &GPIO_InitStruct);
